...
export class NewMigrations1682469413396 implements MigrationInterface {
    name = 'NewMigrations1682469413396'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "guests" ("id" SERIAL NOT NULL, "firstname" character varying NOT NULL, "lastname" character varying NOT NULL, "phonenumber" character varying NOT NULL, "emailaddress" character varying NOT NULL, CONSTRAINT "PK_4948267e93869ddcc6b340a2c46" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "booking_guest" ("guest_id" integer NOT NULL, "booking_id" integer NOT NULL, CONSTRAINT "PK_1d14b2d0b0c1ceaadf5f25d3dbc" PRIMARY KEY ("guest_id", "booking_id"))`);
